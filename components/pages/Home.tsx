      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-96">
            <img src="./images/002.jpeg" alt="" className="absolute top-0 left-0 w-2/3 h-full object-cover rounded-lg shadow-xl"/>
            <img src="./images/003.jpeg" alt="" className="absolute bottom-0 right-0 w-1/2 h-2/3 object-cover rounded-lg shadow-xl border-8 border-[#FDFBF8]"/>
          </div>
        </div>
      </section>
