  ...
  return (
    <div className="space-y-24 md:space-y-32">
      ...
      <section className="relative h-[85vh] min-h-[500px] flex items-end h-100 pb-20 text-white">
        ...
        <img src="https://github.com/nikitaadangi/Para_International/blob/main/public/images/001.png?raw=true" alt="Exquisite marble architecture" className="absolute inset-0 w-full h-full object-cover"/>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-96">
            <img src="https://github.com/nikitaadangi/Para_International/blob/main/public/images/002.jpeg?raw=true" alt="" className="absolute top-0 left-0 w-2/3 h-full object-cover rounded-lg shadow-xl"/>
            <img src="https://github.com/nikitaadangi/Para_International/blob/main/public/images/003.jpeg?raw=true" alt="" className="absolute bottom-0 right-0 w-1/2 h-2/3 object-cover rounded-lg shadow-xl border-8 border-[#FDFBF8]" />
          </div>
        </div>
      </section>
