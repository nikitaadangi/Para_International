  ...
  return (
    <div className="space-y-24 md:space-y-32">
      ...
      <section className="relative h-[85vh] min-h-[500px] flex items-end h-100 pb-20 text-white">
        ...
        <img src="https://500px.com/photo/71870821/evening-stroll...-by-alx041#google_vignette" alt="Exquisite marble architecture" className="absolute inset-0 w-full h-full object-cover"/>
